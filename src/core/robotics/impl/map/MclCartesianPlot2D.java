...
import core.robotics.IMclMap;
import core.robotics.datatypes.IMclMove;
import core.robotics.impl.datatypes.Angle;
import core.robotics.impl.datatypes.IPose2D;
import core.robotics.impl.datatypes.AbstractRangeReading;
import core.util.math.geom.CartesianPlot2D;
import core.util.math.geom.IGroupParser;
import core.util.math.geom.shapes.IGeometric2D;
import core.util.math.geom.shapes.Point2D;
import core.util.math.geom.shapes.Ray2D;
import core.util.math.geom.shapes.Rect2D;
import core.util.math.geom.shapes.Vector2D;
